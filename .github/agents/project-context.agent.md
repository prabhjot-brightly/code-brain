...
description: "Run this FIRST before fixing, reviewing, or exploring code. Queries the Neo4j knowledge graph to surface relevant project structure, key symbols, and entry points for the task — so downstream work needs zero directory scans or broad file reads."
tools: [repo-knowledge-graph/get_stats, repo-knowledge-graph/query_codebase, repo-knowledge-graph/get_node_context]
agents: []
